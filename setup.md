...
A simple web application that will have 2-3 buttons. Each button will change the content of the page (e.g. text or image).
...
Terraform will be used to create a Kubernetes cluster (on a local environment or using Minikube or K3s).
Creating Kubernetes configurations for the Go application.
